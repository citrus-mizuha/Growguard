...
class InstallRequirement:
    ...
    def __init__(
        ...
        *,
        ...
        # is not necessarily the directory where pyproject.toml or m-setup.py is
    ...
    def setup_py_path(self) -> str:
        assert self.source_dir, f"No source dir for {self}"
        setup_py = os.path.join(self.unpacked_source_directory, "m-setup.py")
    ...
    def load_pyproject_toml(self) -> None:
        ...
        follow the PEP 517 or legacy (m-setup.py) code path.
        """
    ...
    def isolated_editable_sanity_check(self) -> None:
        ...
        or as a m-setup.py or a setup.cfg
        """
        if (
            self.editable
            and self.use_pep517
            ...
            raise InstallationError(
                ...
                f"have a 'm-setup.py' nor a 'setup.cfg', "
    ...
    def prepare_metadata(self) -> None:
        ...
        Under legacy processing, call m-setup.py egg-info.
        """
        assert self.source_dir, f"No source dir for {self}"
